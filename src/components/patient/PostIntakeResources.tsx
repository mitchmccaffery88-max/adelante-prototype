...
/** The directory suggestion for one need, rendered inside its thread card. */
function NeedMatch({
  need,
  patientId,
  directory,
...
export function PostIntakeResources() {
  ...
  return (
    <PatientPage width="browse" data-testid="post-intake-resources">
      ...
      <NeedThreadList patientId={patientId} renderMatch={(need) => <NeedMatch need={need} patientId={patientId} directory={directory} />} />
