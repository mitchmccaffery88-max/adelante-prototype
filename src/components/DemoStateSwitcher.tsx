...
export function DemoStateSwitcher() {
  ...
  return (
    <div className="fixed top-[76px] right-3 z-[70] print:hidden">
      <DropdownMenu>
        <DropdownMenuTrigger
          data-testid="demo-state-switcher"
          className="inline-flex items-center gap-1.5 rounded-full border bg-card/95 px-2.5 py-1 text-[11px] font-medium text-foreground/80 shadow-sm backdrop-blur hover:bg-secondary"
        >
