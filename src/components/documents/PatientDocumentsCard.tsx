...
export function DocumentStatusBadge({
  ...
  if (status === "verified") return <Badge variant="default">In your record</Badge>;
    ...
    <Card className="p-5 space-y-4">
      <div>
        <h2 className="flex items-center gap-2 font-display text-lg text-navy">
          <FileText className="h-5 w-5 text-teal" /> Your documents
        </h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Send paperwork to your care team. A team member reviews everything before it goes into
          your medical record.
        </p>
      </div>
