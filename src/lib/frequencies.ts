...
export const FREQUENCY_CATALOG: MedFrequency[] = [
  ...
  { code: "QAM", label: "QAM — every morning", sigLabel: "every morning", isPrn: false, adminTimes: [8] },
  { code: "QHS", label: "QHS — at bedtime", sigLabel: "at bedtime", isPrn: false, adminTimes: [21] },
  { code: "BID", label: "BID — twice daily", sigLabel: "twice daily", isPrn: false, adminTimes: [8, 20] },
  { code: "TID", label: "TID — three times daily", sigLabel: "three times daily", isPrn: false, adminTimes: [8, 14, 20] },
  { code: "QID", label: "QID — four times daily", sigLabel: "four times daily", isPrn: false, adminTimes: [8, 12, 16, 20] },
  { code: "Q4H", label: "Q4H — every 4 hours", sigLabel: "every 4 hours", isPrn: false, adminTimes: [0, 4, 8, 12, 16, 20] },
  { code: "Q6H", label: "Q6H — every 6 hours", sigLabel: "every 6 hours", isPrn: false, adminTimes: [0, 6, 12, 18] },
  { code: "Q8H", label: "Q8H — every 8 hours", sigLabel: "every 8 hours", isPrn: false, adminTimes: [6, 14, 22] },
  { code: "Q12H", label: "Q12H — every 12 hours", sigLabel: "every 12 hours", isPrn: false, adminTimes: [8, 20] },
  { code: "QWK", label: "QWK — once weekly", sigLabel: "once weekly", isPrn: false, adminTimes: [8], intervalDays: 7 } as MedFrequency & { intervalDays: number },
  { code: "PRN", label: "PRN — as needed", sigLabel: "as needed", isPrn: true, adminTimes: [], maxPerDay: 4 },
  { code: "Q4H_PRN", label: "Q4H PRN — as needed, up to every 4 hours", sigLabel: "every 4 hours as needed", isPrn: true, adminTimes: [], maxPerDay: 6 },
  { code: "Q6H_PRN", label: "Q6H PRN — as needed, up to every 6 hours", sigLabel: "every 6 hours as needed", isPrn: true, adminTimes: [], maxPerDay: 4 },
  { code: "QHS_PRN", label: "QHS PRN — as needed at bedtime", sigLabel: "at bedtime as needed", isPrn: true, adminTimes: [], maxPerDay: 1 },
];
