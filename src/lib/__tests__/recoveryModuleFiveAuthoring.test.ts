// §Content-authoring pass Batch 5 — Module 5 authoring + anti-templating guard.
...
import { HEALING_MY_RELATIONSHIPS_FIELDS } from "@/lib/recovery.healingMyRelationships.authored";

const lessons = () => liveLessonsInModule("healing-my-relationships");

describe("Module 5 'Healing My Relationships' is really authored, not templated", () => {
  ...
  it("ships as PUBLISHED overrides authored by Cathy, not baseline edits", () => {
    for (const f of HEALING_MY_RELATIONSHIPS_FIELDS) {
...
describe("Module 5 keeps the established voice and format", () => {
