// §Content-authoring pass Batch 4 — Module 4 authoring + anti-templating guard.
...
import { CHANGING_MY_EVERYDAY_LIFE_FIELDS } from "@/lib/recovery.changingMyEverydayLife.authored";

const lessons = () => liveLessonsInModule("changing-my-everyday-life");

describe("Module 4 'Changing My Everyday Life' is really authored, not templated", () => {
  ...
  it("ships as PUBLISHED overrides authored by Cathy, not baseline edits", () => {
    for (const f of CHANGING_MY_EVERYDAY_LIFE_FIELDS) {
...
describe("Module 4 keeps the established voice and format", () => {
