...
function IntakePage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-8">
      ...
      <div className="fixed md:sticky bottom-[calc(4.5rem+env(safe-area-inset-bottom))] md:bottom-0 left-0 right-0 md:left-auto md:right-auto z-30 mt-5 flex justify-between gap-3 bg-background/95 backdrop-blur border-t md:border-0 md:bg-transparent px-4 md:px-0 py-3 md:py-0">
