...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Adelante Pathways is a HIPAA-compliant web app for teletherapy and reentry support for justice-involved individuals." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Adelante Pathways is a HIPAA-compliant web app for teletherapy and reentry support for justice-involved individuals." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Adelante Pathways is a HIPAA-compliant web app for teletherapy and reentry support for justice-involved individuals." },
